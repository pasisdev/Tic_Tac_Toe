    ...
    this.GetInvokeArguments = function (View, ArgsP) {
      ...
      function ReadUnicodeString() {
        ...
        if ((Ptr % 2) === 0) {
          ...
          aRawBytes = new Uint8Array(View.buffer,Ptr,Len * 2);
          aBytes = new Uint8Array(aRawBytes.buffer);
          aWords = new Uint16Array(aBytes.buffer);
        };
        Result = $Self.DecodeUTF16Buffer(aWords);
        return Result;
      };
  ...
  rtl.createClass(this,"TMyApplication",pas.wasihostapp.TBrowserWASIHostApplication,function () {
    ...
    this.DataLoaded = function (Event) {
      ...
      function DoStartWebAssembly() {
        pas.System.Writeln("Starting WebAssembly program from Tic_Tac_Toe.wasm");
        $Self.StartWebAssembly("Tic_Tac_Toe.wasm?random_suffix_to_avoid_cache=GAPK098",true,rtl.createCallback($Self,"DoBeforeStart"),null);
      };
      var Xhr = null;
    ...
    this.DoRun = function () {
      var Xhr = null;
      var DataUrl = "";
      DataUrl = "Tic_Tac_Toe_data.zip?random_suffix_to_avoid_cache=GAPK098";
